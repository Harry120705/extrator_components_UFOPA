...
def get_base_dir_from_args_or_env():
    ...
    return os.path.abspath(args.base_dir or os.getenv('EXTRACTION_BASE_DIR') or os.getcwd())
...
@app.route('/upload_and_extract', methods=['POST'])
def upload_and_extract():
    # permite pular o upload do arquivo de percentuais enviando skip_percentuals=1
    skip_percentuais = request.form.get('skip_percentuals') in ('1', 'true', 'on', 'yes')
